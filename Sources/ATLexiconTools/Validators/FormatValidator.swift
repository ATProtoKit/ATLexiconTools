...
extension Validator.Format {
    ...
    public static func validateDateTime(path: String, dateTimeValue: String) throws -> PrimitiveValue {
        let formats = [
    ...
    public static func validateURI(path: String, uriValue: String) throws -> PrimitiveValue {
    ...
    public static func validateATURI(path: String, atURIValue: String) throws -> PrimitiveValue {
        guard ATURIValidator.isValid(atURIValue) == true else {
            throw LexiconValidatorError.notAValidURI(path: path)
        }

        return .string(atURIValue)
    }
    ...
    public static func validateDID(path: String, didValue: String) throws -> PrimitiveValue {
    ...
    public static func validateHandle(path: String, handleValue: String) throws -> PrimitiveValue {
    ...
    public static func validateATIdentifier(path: String, atIdentifier: String) throws -> PrimitiveValue {
        if atIdentifier.starts(with: "did:") {
            let result = try validateDID(path: path, didValue: atIdentifier)
            return result
        }

        do {
            let result = try validateHandle(path: path, handleValue: atIdentifier)
            return result
        } catch {
    ...
    /// AT Protocol specifications.
    public static func validateNSID(path: String, nsidValue: String) throws -> PrimitiveValue {
        guard NSIDValidator.isValid(nsidValue) == true else {
            throw LexiconValidatorError.notAValidHandle(path: path)
        }

        return .string(nsidValue)
    }
    ...
    public static func validateCID(path: String, cidValue: String) throws -> PrimitiveValue {
        do {
    ...
    public static func validateLanguage(path: String, languageValue: String) throws -> PrimitiveValue {
        let regex = #"""
...
"""#
    ...
    public static func validateTID(path: String, tidValue: String) throws -> PrimitiveValue {
        guard TIDValidator.isValid(tidValue) == true else {
            throw LexiconValidatorError.notAValidTID(path: path)
        }

        return .string(tidValue)
    }
    ...
    public static func validateRecordKey(path: String, recordKeyValue: String) throws -> PrimitiveValue {
        guard RecordKeyValidator.isValid(recordKeyValue) == true else {
            throw LexiconValidatorError.notAValidRecordKey(path: path)
        }

        return .string(recordKeyValue)
    }
}
